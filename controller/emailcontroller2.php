...
class email_controller2 extends Connection
{
    // Obtener correos de los administradores
    public function EncabezadoEmail_ComprobanteElectronico()
    {
        $sql = "
    ...
    public function obtenerCuerpoEmail_ComprobanteElectronico()
    {
        $sql = "
    ...
    public function sendComprobanteElectronicoEmail()
    {
        ...
        try {
            ...
            $DatosEncabezado = $this->EncabezadoEmail_ComprobanteElectronico(); // Obtén todos los administradores
            if ($DatosEncabezado && $DatosEncabezado->num_rows > 0) {
                // Obtener los detalles del cuerpo del correo
                $DatosCuerpo = $this->obtenerCuerpoEmail_ComprobanteElectronico();
