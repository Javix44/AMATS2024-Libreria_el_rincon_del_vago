...
if (!defined('PDF_ITCA_LOGO')) {
	$tcpdf_itca_logo = '';
	if (@file_exists(K_PATH_IMAGES . 'Logo_nuevo.png')) {
		$tcpdf_itca_logo = 'Logo_nuevo.png';
	}
	define('PDF_ITCA_LOGO', $tcpdf_itca_logo);
}
if (!defined('PDF_CDA_LOGO')) {
	$tcpdf_cda_logo = '';
	if (@file_exists(K_PATH_IMAGES . 'Logo_cda.jpg')) {
		$tcpdf_cda_logo = 'Logo_cda.jpg';
	}
	define('PDF_CDA_LOGO', $tcpdf_cda_logo);
}
